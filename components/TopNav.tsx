  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-30 flex items-center justify-between px-3 py-2 safe-top sm:px-6 sm:py-3 glass">
      ...
      <button
        ...
        className="flex items-center gap-1.5 rounded-full px-2.5 py-1.5 text-sm text-white/70 bg-white/10 border border-white/10 backdrop-blur-sm transition-all duration-200 hover:bg-white/20 hover:text-white hover:border-white/20 sm:px-4"
      >
      ...
      <div className="flex items-center gap-1 sm:gap-6">
        <button
          onClick={onOpenTools}
          className="flex h-8 w-8 items-center justify-center rounded-full text-sm text-white/60 transition-all duration-200 hover:text-white hover:bg-white/10 sm:h-auto sm:w-auto sm:rounded-none sm:text-sm sm:text-white/60 sm:hover:bg-transparent sm:hover:underline sm:hover:underline-offset-4"
          title={t('nav.tools')}
        >
